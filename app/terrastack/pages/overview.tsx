...
export const overviewTableOfContents = [
  { id: 'overview', title: 'Overview', level: 2 },
  { id: 'key-features', title: 'Key Features', level: 3 },
  { id: 'why-terrastack', title: 'Why Terra Stack?', level: 3 },
];
  ...
  return (
    <div>
      ...
      <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
        ...
        <br />
        <i>
          &nbsp;&nbsp;&nbsp;&nbsp; If we could redo the core protocol of the Internet from scratch, what would it look
          like?
        </i>
      </p>
      ...
      >
        ...
        <p className="text-muted-foreground mb-4 leading-relaxed">
          ...
          starts to reach its final form. The goal of Terra Stack is to provide a model for a more advanced iteration of
          a protocol stack that is capable of running the Internet.
        </p>
      </section>
      ...
      >
        ...
        <div className="">
          <p>Terra Stack combines currently disparate technologies into a single multi-threaded portable executable.</p>
          <ol>
            <li>
            ...
            <li>
              Routing - Routing is based on theoretical principles and eliminates some of the peculiarities associated
              with IPv4 such as high-latency between nodes that are geographically adjacent.
            </li>
            ...
            <li>
              Large-Scale Multicast - In full-deployment of Terra Stack, a single source node would be able to multicast
              to 1,000,000 target nodes with essentially no performance degradation.
            </li>
          </ol>
        </div>
      </section>
